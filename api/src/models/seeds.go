...
func SeedDemoData() {
	...
	spots := []Spot{
		...
		},
		{
			...
			Description: "A great independent specialty coffee shop on Peter Street. Monochrome chequered floors, Bauhaus art prints and free wifi make it a popular haunt for remote workers. Opens at 7:30am on weekdays.",
			OpenFrom:    "07:30",
			OpenTo:      "22:00",
		},
		{
		...
		},
		{
			...
			Description: "A charming Edinburgh sanctuary for book lovers and coffee enthusiasts. Rustic decor, cozy leather seating. Some tables are designated laptop-free. Open late — perfect for evening working sessions.",
			OpenFrom:    "09:00",
			OpenTo:      "22:00",
		},
	}
